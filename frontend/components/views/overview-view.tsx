...
export function OverviewView() {
  ...
  const recentTracks = [
    { id: 1, title: "Midnight City (Eric Prydz Remix)", artist: "M83", time: "2 hours ago" },
    { id: 2, title: "Innerbloom", artist: "RÜFÜS DU SOL", time: "5 hours ago" },
    { id: 3, title: "Strobe", artist: "deadmau5", time: "Yesterday" },
    { id: 4, title: "Inspector Norse", artist: "Todd Terje", time: "Yesterday" },
    { id: 5, title: "Opus", artist: "Eric Prydz", time: "2 days ago" },
    { id: 6, title: "Bicep", artist: "Glue", time: "2 days ago" },
  ];
        ...
        <div className="px-4 md:px-8 py-8 max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto pr-2 space-y-1 no-scrollbar">
                {recentTracks.map((track) => (
                  <div key={track.id} className="relative flex items-center justify-between p-3 rounded-lg hover:bg-zinc-900/60 transition-colors group cursor-pointer">
            ...
            <motion.div 
              ...
              className="md:col-span-4 bg-zinc-950 border border-zinc-900 rounded-xl p-6 hover:border-zinc-800 transition-all duration-300 flex flex-col h-full min-h-[400px]"
            >
